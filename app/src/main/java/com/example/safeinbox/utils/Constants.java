...
public class Constants {
    ...
    public static final int CURRENT_ENGINE_VERSION = 7; // Ultra Max Forensic Engine v2 (Turbo)
    ...
    public static final String COL_REASON = "classification_reason";

    // Table: similarity_data (Layer 3)
    public static final String TABLE_SIMILARITY_DATA = "similarity_data";
    public static final String COL_BODY_HASH = "body_hash";
    // COL_BODY and COL_LABEL reused from above
