...
public class SmsMessage {
    ...
    private String classificationReason; // NEW: Detailed reasoning
    private boolean isSpam; // Folder indicator (0=Inbox, 1=Spam)

    public SmsMessage() {
        this.classificationStatus = "HAM";
        this.score = 0;
        this.isSpam = false;
    }
    ...
    public SmsMessage(long id, String sender, String senderName, String body, long date, String classificationStatus, String dedupId) {
        ...
        this.isSpam = "SPAM".equalsIgnoreCase(this.classificationStatus) || "SUSPICIOUS".equalsIgnoreCase(this.classificationStatus);
